...
oomol-registry.ap-southeast-1.cr.aliyuncs.com/oomol/wikispine-service:<tag>
```

The workflow uses GitHub OIDC to assume the `docker-registry` Alibaba Cloud RAM role through the
