...
use crate::compact_ac::charwise::{CharwiseDoubleArrayAhoCorasick, CodeMapper, MatchKind, State};
use crate::compact_ac::charwise::{DEAD_STATE_IDX, ROOT_STATE_IDX};
use crate::compact_ac::errors::{DaachorseError, Result};
use crate::compact_ac::nfa_builder::NfaBuilder;
use crate::compact_ac::nfa_builder::{DEAD_STATE_ID, ROOT_STATE_ID};
use crate::compact_ac::utils::FromU32;
use crate::compact_ac::BuildHelper;
