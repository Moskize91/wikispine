...
pub use crate::compact_ac::charwise::builder::CharwiseDoubleArrayAhoCorasickBuilder;
use crate::compact_ac::charwise::iter::{
...
use crate::compact_ac::charwise::mapper::CodeMapper;
...
impl<V> CharwiseDoubleArrayAhoCorasick<V> {
    ...
    /// infinite loops or cause [`Match`](crate::compact_ac::Match) to return inaccurate ranges. Use this
        ...
        V: Serializable,
    {
        ...
        for &id in &pma.mapper.table {
            if id == crate::compact_ac::charwise::mapper::INVALID_CODE {
                continue;
            }
